...
def main():
    parser = argparse.ArgumentParser(description="Step 2: Building vocabulary and fastText embeddings")
    parser.add_argument("--train_csv", type=str, default="datasets/split-sentiment/train.csv")
